...
const PurchaseReport = () => {
  ...
  return (
    <div>
      <PageHeader
        title={t('reports.purchaseReport.title')}
        subtitle={t('reports.purchaseReport.subtitle')}
        breadcrumbs={[{ label: t('common.home'), path: '/admin' }, { label: t('nav.reports') }, { label: t('reports.purchaseReport.title') }]}
        actions={
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-5">
        {[
          { labelKey: 'reports.purchaseReport.totalPurchase' as const, value: totals.total, cls: 'text-[#26272F]' },
          { labelKey: 'reports.purchaseReport.totalPaid' as const, value: totals.paid, cls: 'text-green-600' },
          { labelKey: 'reports.purchaseReport.totalDue' as const, value: totals.due, cls: 'text-red-500' },
        ].map((s) => (
            ...
            <thead>
              <tr className="bg-gray-50 border-b border-[#DBDFE9]">
                {[
                  t('common.date'),
                  t('common.invoice'),
                  t('reports.purchaseReport.colSupplier'),
                  t('reports.purchaseReport.colItems'),
                  t('common.total'),
                  t('common.paid'),
                  t('common.due'),
                ].map((h) => (
