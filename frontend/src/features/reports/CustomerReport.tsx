  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Customer-wise purchase summary and balance"
        breadcrumbs={[{ label: 'Home', path: '/admin' }, { label: 'Reports' }, { label: 'Customer Report' }]}
        actions={
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-5">
        {[
          { label: 'Total Sales', value: totals.total_purchase, cls: 'text-[#26272F]' },
          { label: 'Total Received', value: totals.paid, cls: 'text-green-600' },
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 border-b border-[#DBDFE9]">
                {['Customer', 'Phone', 'Total Purchase', 'Paid', 'Due', 'Last Purchase'].map((h) => (
