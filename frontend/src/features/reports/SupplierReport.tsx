...
const SupplierReport = () => {
  ...
  return (
    <div>
      <PageHeader
        title={t('reports.supplierReport.title')}
        subtitle={t('reports.supplierReport.subtitle')}
        breadcrumbs={[{ label: t('common.home'), path: '/admin' }, { label: t('nav.reports') }, { label: t('reports.supplierReport.title') }]}
        actions={
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-5">
        {[
          { labelKey: 'reports.supplierReport.totalPurchase' as const, value: totals.total_purchase, cls: 'text-[#26272F]' },
          { labelKey: 'reports.supplierReport.totalPaid' as const, value: totals.paid, cls: 'text-green-600' },
          { labelKey: 'reports.supplierReport.totalPayable' as const, value: totals.due, cls: 'text-red-500' },
        ].map((s) => (
      ...
      <div className="bg-white border border-[#DBDFE9] rounded-lg shadow-sm">
        <div className="p-4 border-b border-[#DBDFE9]">
          <div className="relative w-full sm:w-64">
            ...
            <input
              type="text"
              placeholder={t('reports.supplierReport.searchPlaceholder')}
              value={search}
            ...
            <thead>
              <tr className="bg-gray-50 border-b border-[#DBDFE9]">
                {[
                  t('common.supplier'),
                  t('common.name'),
                  t('reports.supplierReport.colTotalPurchase'),
                  t('common.paid'),
                  t('reports.supplierReport.colPayable'),
                  t('reports.supplierReport.colLastPurchase'),
                ].map((h) => (
