...
const HRMReport = () => {
  ...
  const summaryData = [
    { labelKey: 'reports.hrmReport.totalEmployees' as const, value: '24', sub: '20 active, 4 on leave' },
    { labelKey: 'reports.hrmReport.thisMonthPayroll' as const, value: '৳3,24,500', sub: 'Net salary disbursed' },
    { labelKey: 'reports.hrmReport.attendanceRate' as const, value: '94.2%', sub: 'May 2025 average' },
    { labelKey: 'reports.hrmReport.pendingLeaves' as const, value: '7', sub: 'Awaiting approval' },
  ];

  return (
    <div>
      <PageHeader
        title={t('reports.hrmReport.title')}
        subtitle={t('reports.hrmReport.subtitle')}
        breadcrumbs={[{ label: t('common.home'), path: '/admin' }, { label: t('nav.reports') }, { label: t('reports.hrmReport.title') }]}
        actions={
      ...
      <div className="bg-white border border-[#DBDFE9] rounded-lg shadow-sm">
        <div className="px-4 py-3 border-b border-[#DBDFE9]">
          <h3 className="text-sm font-semibold text-[#26272F]">{t('reports.hrmReport.deptSummary')}</h3>
        </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 border-b border-[#DBDFE9]">
                {[
                  t('reports.hrmReport.colDept'),
                  t('reports.hrmReport.colEmployees'),
                  t('reports.hrmReport.colAvgSalary'),
                  t('reports.hrmReport.colAttendance'),
                ].map((h) => (
