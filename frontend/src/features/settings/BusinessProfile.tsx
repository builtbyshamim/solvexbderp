  ...
  return (
    <div>
      <PageHeader
        ...
        breadcrumbs={[{ label: 'Home', path: '/admin' }, { label: 'Settings' }, { label: 'Business Profile' }]}
      />
      ...
      <form onSubmit={handleSubmit} className="space-y-5 max-w-2xl">
        <div className="bg-white border border-[#DBDFE9] rounded-lg shadow-sm overflow-hidden">
          <div className="flex items-center gap-2 px-5 py-4 border-b border-[#DBDFE9] bg-gray-50">
            ...
            <h3 className="text-sm font-semibold text-[#26272F]">Business Information</h3>
          </div>
        ...
        <div className="bg-white border border-[#DBDFE9] rounded-lg shadow-sm overflow-hidden">
          <div className="flex items-center gap-2 px-5 py-4 border-b border-[#DBDFE9] bg-gray-50">
            ...
            <h3 className="text-sm font-semibold text-[#26272F]">Contact Details</h3>
          </div>
          <div className="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
        ...
        <div className="bg-white border border-[#DBDFE9] rounded-lg shadow-sm overflow-hidden">
          <div className="flex items-center gap-2 px-5 py-4 border-b border-[#DBDFE9] bg-gray-50">
            ...
            <h3 className="text-sm font-semibold text-[#26272F]">Address</h3>
          </div>
          <div className="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
        ...
        <div className="bg-white border border-[#DBDFE9] rounded-lg shadow-sm overflow-hidden">
          <div className="flex items-center gap-2 px-5 py-4 border-b border-[#DBDFE9] bg-gray-50">
            ...
            <h3 className="text-sm font-semibold text-[#26272F]">Regional Settings</h3>
          </div>
          <div className="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
