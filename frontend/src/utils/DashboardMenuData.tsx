  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      subMenu: [
        ...
        { id: 7, name: t('nav.inventory.stockAdjustment'),path: '/admin/inventory/stock-adjustment' },
    ...
    },
    {
      ...
      subMenu: [
        ...
        { id: 6, name: t('nav.smsMarketing.dueReminder'),    path: '/admin/sms-marketing/due-reminder' },
        { id: 10, name: t('nav.smsMarketing.notifications'), path: '/admin/sms-marketing/notifications' },
        ...
        { id: 9, name: t('nav.smsMarketing.configuration'),  path: '/admin/sms-marketing/configuration' },
      ],
    },
    {
      id: 10,
